...
class GAT(nn.Module):
    def __init__(self, in_dim, hid_dim, class_num, alpha, dropout, nheads, use_cuda):
        ...
        self.attentions = [GraphAttentionLayer(self.in_dim, self.hid_dim, self.alpha, self.dropout, nonlinear=False, use_cuda=self.use_cuda) for _ in range(self.nheads)]
